...
partner-event-datetime-prompt = Введите дату и время. Подойдут форматы <b>2026.01.01 00:00</b> и <b>01.01.2026 00:00</b>.

partner-event-datetime-invalid = Некорректный формат даты и времени. Используйте, например, <b>2026.01.01 00:00</b> или <b>01.01.2026 00:00</b>.

partner-event-datetime-past = Дата должна быть в будущем. Пример: <b>10.04.2026 20:00</b>.

partner-event-address-prompt = Введите место встречи свободным текстом. Можно указать заведение, район, метро или ориентир.
...
partner-event-edit-address-button = Редактировать место встречи
...
partner-event-label-address = <b>Место встречи:</b> { $value }

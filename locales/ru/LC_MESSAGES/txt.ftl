...
partner-event-auto-message-prompt = Введите текст авто-сообщения пользователю после регистрации.

partner-event-auto-message-invalid = Текст авто-сообщения не должен быть пустым.
...
partner-event-preview-auto-message =
    Авто-сообщение пользователю после регистрации:
    { $text }
...
partner-event-edit-auto-message-button = Редактировать авто-сообщение
...
partner-event-going-thanks =
    ...
    Если вы уже оплатили участие, пожалуйста, <b>не забудьте нажать кнопку «Я оплатил(а)»</b> внизу формы регистрации.
...
partner-event-registrations-pending-prompt =
    Отправьте чек в ответ на это сообщение, чтобы подтвердить оплату пользователя
    { $user_id } для события «{ $event_name }».
partner-event-registrations-pending-sent = Сообщение для подтверждения оплаты отправлено.
partner-event-registrations-pending-failed = Не удалось подготовить подтверждение оплаты.
partner-event-registrations-pending-missing = Не удалось найти регистрацию для подтверждения.
